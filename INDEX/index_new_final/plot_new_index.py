...
Plots the updated GEP index (share of articles mentioning ≥1 dictionary word).

Produces two figures:
  1. GEP_Monthly_Updated.png  — horizontal monthly line chart with annotated peaks
  2. GEP_Daily_Updated.png    — vertical daily scatter + monthly line with event labels
"""
...
ax.set_title("GEP Monthly Index — Updated (1996–2025)", fontsize=13, pad=12)
ax.set_xlabel("")
...
plt.tight_layout()
out_monthly = os.path.join(BASE, "GEP_Monthly_Updated.png")
plt.savefig(out_monthly, dpi=150, bbox_inches="tight")
print(f"Saved: {out_monthly}")
plt.close()


# ══════════════════════════════════════════════════════════════════════════════
# PLOT 2 — Vertical: Daily dots + Monthly line + Event labels
# ══════════════════════════════════════════════════════════════════════════════
...
raw_peaks = [
    (find_nearby_peak(d)[0], find_nearby_peak(d)[1], lbl)
    for d, lbl in EVENTS
]
...
ax.set_title("Daily GEP Index — Updated (1996–2025)", fontsize=13, pad=10)
...
plt.tight_layout()
out_daily = os.path.join(BASE, "GEP_Daily_Updated.png")
plt.savefig(out_daily, dpi=160, bbox_inches="tight")
