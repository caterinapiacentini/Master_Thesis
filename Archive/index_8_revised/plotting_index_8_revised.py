...
ax.set_title('GEP Monthly Index — Revised (1996–2025)', fontsize=13, pad=12)
ax.set_xlabel('')
...
plt.tight_layout()
plt.savefig(f"{BASE}/GEP_Monthly_Index_Revised.png", dpi=150, bbox_inches='tight')
print("Saved: GEP_Monthly_Index_Revised.png")
plt.close()
...
X_DATA_MAX = daily_obs['score_scaled'].quantile(0.999)
...
ax.set_title('Daily GEP Index — Revised (1996–2025)', fontsize=13, pad=10)
...
plt.tight_layout()
plt.savefig(f"{BASE}/GEP_Daily_Events_Revised.png", dpi=160, bbox_inches='tight')
print("Saved: GEP_Daily_Events_Revised.png")
plt.close()
