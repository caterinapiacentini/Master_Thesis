...
class GTM():
    ...
    def run(self, params, pos_seed, neg_seed): 
        ...
        # Dynamically create filename based on the first two positive words
...
if __name__ == '__main__':
    ...
    # --- DYNAMIC LIST ARGUMENTS ---
    parser.add_argument('--model_path', type=str, required=True, help="Path to your Word2Vec .pkl dictionary")
    parser.add_argument('--pos_words', nargs='+', type=str, required=True, help="List of positive seed words (e.g. sanctions tariffs)")
    parser.add_argument('--pos_weights', nargs='+', type=float, required=True, help="List of weights for positive seeds (e.g. 1.0 1.0)")
    ...
    parser.add_argument('--size', type=str, required=True, help="Number of words to collect")
    parser.add_argument('--gravity', type=str, required=True, help="Gravity parameter (e.g. 1.5)")
