...
# -*- coding: utf-8 -*-
"""
plot_robust_min4_normalized.py

Plots the robust min-4 GEP index normalized to 100 over 1996-2025,
following Caldara & Iacoviello (2022) convention.

Produces:
  1. GEP_Monthly_Robust_min4_norm100.png
  2. GEP_Daily_Robust_min4_norm100.png
"""
...
# ── Load data ──────────────────────────────────────────────────────────────────
monthly = pd.read_csv(os.path.join(BASE, "GEP_Monthly_Robust_min4.csv"))
monthly["month"] = pd.to_datetime(monthly["month"])

daily = pd.read_csv(os.path.join(BASE, "GEP_Daily_Robust_min4.csv"))
...
ax.set_title("GEP Monthly Index — Robust min-4, normalized to 100 (1996–2025)", fontsize=13, pad=12)
ax.set_xlabel("")
...
plt.tight_layout()
out = os.path.join(BASE, "GEP_Monthly_Robust_min4_norm100.png")
...
ax.set_title("Daily GEP Index — Robust min-4, normalized to 100 (1996–2025)", fontsize=13, pad=10)
...
plt.tight_layout()
out = os.path.join(BASE, "GEP_Daily_Robust_min4_norm100.png")
