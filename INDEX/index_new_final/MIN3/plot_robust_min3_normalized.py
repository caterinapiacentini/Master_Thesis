...
# -*- coding: utf-8 -*-
"""
plot_robust_min3_normalized.py

Plots the robust min-3 GEP index normalized to 100 over 1996-2025,
following Caldara & Iacoviello (2022) convention.

Produces:
  1. GEP_Monthly_Robust_min3_norm100.png
  2. GEP_Daily_Robust_min3_norm100.png
"""
...
# ── Load data ──────────────────────────────────────────────────────────────────
monthly = pd.read_csv(os.path.join(BASE, "GEP_Monthly_Robust_min3.csv"))
monthly["month"] = pd.to_datetime(monthly["month"])

daily = pd.read_csv(os.path.join(BASE, "GEP_Daily_Robust_min3.csv"))
...
# normalize monthly on same daily scale for overlay
...
ax.set_title("GEP Monthly Index — Robust min-3, normalized to 100 (1996–2025)", fontsize=13, pad=12)
ax.set_xlabel("")
...
plt.tight_layout()
out = os.path.join(BASE, "GEP_Monthly_Robust_min3_norm100.png")
...
ax.set_title("Daily GEP Index — Robust min-3, normalized to 100 (1996–2025)", fontsize=13, pad=10)
...
plt.tight_layout()
out = os.path.join(BASE, "GEP_Daily_Robust_min3_norm100.png")
