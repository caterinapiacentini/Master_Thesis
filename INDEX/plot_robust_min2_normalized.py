...
ROB_DIR  = os.path.join(BASE, "index_new_final", "MIN2")

# ── Load data ──────────────────────────────────────────────────────────────────
monthly = pd.read_csv(os.path.join(ROB_DIR, "GEP_Monthly_Robust_min2.csv"))
monthly["month"] = pd.to_datetime(monthly["month"])

daily = pd.read_csv(os.path.join(ROB_DIR, "GEP_Daily_Robust_min2.csv"))
...
plt.tight_layout()
out = os.path.join(ROB_DIR, "GEP_Monthly_Robust_min2_norm100.png")
...
plt.tight_layout()
out = os.path.join(ROB_DIR, "GEP_Daily_Robust_min2_norm100.png")
